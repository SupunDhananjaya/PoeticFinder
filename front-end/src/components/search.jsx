...
export default function SearchBar({poemName,setPoemName,metaphor,lyrics,author,setMetaphor,setLyrics,setAuthor,handleSearch}){
    ...
    return(
        <Grid container spacing={1} alignItems="center">
            ...
            <Grid item xs={2.5}>
                <TextField id='poem' value={poemName} onChange={handleChange} label="Search by poem name" color="primary" fullWidth />
            </Grid>
            <Grid item xs={2.5}>
